...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-httpx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13373&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-httpx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-httpx` can be installed with:

```
conda install pytest-httpx
```

It is possible to list all of the versions of `pytest-httpx` available on your platform with:
